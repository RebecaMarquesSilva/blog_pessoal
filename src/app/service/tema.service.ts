...
export class TemaService {
  ...
  getAllTema(): Observable<Tema[]> {
    return this.http.get<Tema[]>('http://localhost:8080/temas/all', this.token)
  }
  ...
  postTema(tema: Tema): Observable<Tema> {
    return this.http.post<Tema>('http://localhost:8080/temas/novo', tema, this.token)
  }

  putTema(tema: Tema): Observable<Tema> {
    return this.http.put<Tema>('http://localhost:8080/temas/atualizacao', tema, this.token)
  }
